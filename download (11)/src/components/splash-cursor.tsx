...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    if (!gl || !ext) {
        console.error("Failed to get WebGL context or extensions.");
        return;
    }
    ...
    function generateColor(): ColorRGB {
        const yellowHue = 45 / 360; // Yellow is around 45-60 degrees
        const blueHue = 220 / 360; // Blue is around 210-240 degrees
        
        // Choose randomly to start from yellow or blue
        const baseHue = Math.random() > 0.5 ? yellowHue : blueHue;
        
        // Add a small random offset to get variations
